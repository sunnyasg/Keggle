...
local_directory <- paste(getwd(),"CourseSessions/Temp23", sep="/")
...
datafile_name="Kaggle_YourCabs_Score" # do not add .csv at the end! make sure the data are numeric!!!! check your file!

# Please ENTER the filename of the Report and Slides (in the doc directory) to generate 

#--Sunny--report_file = "Report_s23"
#report_file = "Kaggle_YourCabs_Score"
report_file = "SKK_Report_s23"
#--Sunny--slides_file = "Slides_s23"

# Please ENTER then original raw attributes to use. 
# Please use numbers, not column names! e.g. c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8
factor_attributes_used= c(3:15)
...
if (datafile_name == "Kaggle_YourCabs_Score")
...
#  Boats=data.matrix(Boats) # this file needs to be converted to "numeric"....
  Kaggle <- read.csv(paste(local_directory, "data/Kaggle_YourCabs_Score.csv", sep = "/"), sep=";", dec=",") # this contains only the matrix ProjectData
  Kaggle=data.matrix(Kaggle) # this file needs to be converted to "numeric"....
